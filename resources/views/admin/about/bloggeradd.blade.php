...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加博主简介</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="{{action('Admin\AboutController@bloggeradd')}}" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content"  id="myueditor" placeholder="请输入问答内容" class="input"  style="height:450px; border:1px solid #ddd;" data-validate="required:请输入问答内容"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
